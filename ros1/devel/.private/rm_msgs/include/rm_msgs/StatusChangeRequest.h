...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef BLUE
#endif
#if defined(_WIN32) && defined(PURPLE)
  #undef PURPLE
#endif
#if defined(_WIN32) && defined(ARMOR)
  #undef ARMOR
#endif
#if defined(_WIN32) && defined(SMALL_BUFF)
  #undef SMALL_BUFF
#endif
#if defined(_WIN32) && defined(BIG_BUFF)
  #undef BIG_BUFF
#endif
...
struct MD5Sum< ::rm_msgs::StatusChangeRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x234814f1a8b7e6c1ULL;
  static const uint64_t static_value2 = 0x00131cfc0419b6baULL;
};
