...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ChassisCmd>)))
  ...
  "fe292a7583b47379f8efee0364a443f5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ChassisCmd)))
  "Returns md5sum for a message object of type 'ChassisCmd"
  "fe292a7583b47379f8efee0364a443f5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ChassisCmd>)))
  ...
  (cl:format cl:nil "uint8 RAW = 0~%uint8 FOLLOW = 1~%uint8 TWIST = 2~%uint8 UP_SLOPE = 3~%uint8 FALLEN = 4~%~%uint8 mode~%geometry_msgs/Accel accel~%float64 power_limit~%string follow_source_frame~%string command_source_frame~%time stamp~%~%================================================================================~%MSG: geometry_msgs/Accel~%# This expresses acceleration in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ChassisCmd)))
  "Returns full string definition for message of type 'ChassisCmd"
  (cl:format cl:nil "uint8 RAW = 0~%uint8 FOLLOW = 1~%uint8 TWIST = 2~%uint8 UP_SLOPE = 3~%uint8 FALLEN = 4~%~%uint8 mode~%geometry_msgs/Accel accel~%float64 power_limit~%string follow_source_frame~%string command_source_frame~%time stamp~%~%================================================================================~%MSG: geometry_msgs/Accel~%# This expresses acceleration in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
