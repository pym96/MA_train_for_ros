...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DartClientCmd>)))
  ...
  "0411c0f6c4a7e463f78cc3d240a1860e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DartClientCmd)))
  "Returns md5sum for a message object of type 'DartClientCmd"
  "0411c0f6c4a7e463f78cc3d240a1860e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DartClientCmd>)))
  ...
  (cl:format cl:nil "uint8 dart_launch_opening_status~%uint8 dart_attack_target~%uint16 target_change_time~%uint8 first_dart_speed~%uint8 second_dart_speed~%uint8 third_dart_speed~%uint8 fourth_dart_speed~%uint16 last_dart_launch_time~%uint16 operate_launch_cmd_time~%~%uint8 CLOSED = 1~%uint8 OPENING_OR_CLOSING = 2~%uint8 OPENED = 0~%~%time stamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DartClientCmd)))
  "Returns full string definition for message of type 'DartClientCmd"
  (cl:format cl:nil "uint8 dart_launch_opening_status~%uint8 dart_attack_target~%uint16 target_change_time~%uint8 first_dart_speed~%uint8 second_dart_speed~%uint8 third_dart_speed~%uint8 fourth_dart_speed~%uint16 last_dart_launch_time~%uint16 operate_launch_cmd_time~%~%uint8 CLOSED = 1~%uint8 OPENING_OR_CLOSING = 2~%uint8 OPENED = 0~%~%time stamp~%~%~%"))
